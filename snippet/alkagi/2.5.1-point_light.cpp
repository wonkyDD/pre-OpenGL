...
int main()
{
    ...
    */
    ...
    while (!glfwWindowShouldClose(g_mainWindow))
    {
        ...
        // mainShader.setVec3("light.direction", lightDir);
        mainShader.setVec3("light.position", lightPos);

        mainShader.setVec3("light.ambient", glm::vec3(1.0f) * glm::vec3(0.1f)); // ambient intensity
        mainShader.setVec3("light.diffuse", glm::vec3(1.0f) * glm::vec3(0.5f)); // diffuse intensity

...
int main()
{
    ...
    */
    ...
    while (!glfwWindowShouldClose(g_mainWindow))
    {
        ...
        mainShader.setFloat("light.cutOff", glm::cos(glm::radians(5.0f)));

        mainShader.setVec3("light.ambient", glm::vec3(1.0f) * glm::vec3(0.1f));
        mainShader.setVec3("light.diffuse", glm::vec3(1.0f) * glm::vec3(0.5f));
        mainShader.setVec3("light.specular", 1.0f, 1.0f, 1.0f);
        mainShader.setFloat("light.constant", 1.0f);
        mainShader.setFloat("light.linear", 0.09f);
        mainShader.setFloat("light.quadratic", 0.032f);
